      ...
      <Section className="bg-primary/10">
        <Container size="4">
          <Flex
            direction="column"
            align="center"
            className="max-w-4xl mx-auto text-center py-20 lg:py-48"
          >
            <Heading size="9" className="text-foreground mb-6 leading-tight">
              Software <span className="text-primary">Rebuilt Smarter</span>
            </Heading>
            <Text
              size="6"
          ...
          >
            <Card className="text-center hover:shadow-lg transition-shadow">
              <Flex direction="column" align="center" justify="center" p="4">
                <Box className="p-4 bg-primary/10 rounded-full flex items-center justify-center mb-6">
          ...
          >
            <Card>
              <Flex direction="column" p="4">
                ...
                <Flex align="center">
                  <Box className="px-3.5 py-3 bg-primary/10 rounded-full flex items-center justify-center mr-4">
            ...
            <Card className="p-8">
              <Flex direction="column" p="4">
                ...
                <Flex align="center">
                  <Box className="px-3 py-3 bg-primary/10 rounded-full flex items-center justify-center mr-4">
                    <Text weight="bold" className="text-primary">
                      MC
                    </Text>
                  </Box>
