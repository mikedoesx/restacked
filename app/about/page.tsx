...
import { Code2, Users, Target, Award, ArrowRight, CheckCircle } from "lucide-react"
  ...
  return (
    <Box className="min-h-screen">
        ...
        <Container size="4">
          <Flex direction="column" align="center" className="max-w-4xl mx-auto text-center">
            <Heading size="9" className="text-foreground mb-6 leading-tight">
              Building the Future of <span className="text-primary">Software</span>
            </Heading>
            <Text size="6" className="text-muted-foreground mb-10 max-w-3xl leading-relaxed">
              We're a team of passionate developers, architects, and consultants dedicated to creating exceptional
      ...
      <Section className="py-20">
        <Container size="4">
          <Grid columns={{ initial: "1", md: "2" }} gap="12" className="max-w-6xl mx-auto">
            <Box>
              <Heading size="7" className="text-foreground mb-6">
                Our Mission
              </Heading>
              <Text size="4" className="text-muted-foreground leading-relaxed mb-6">
                To empower businesses with cutting-edge software solutions that are not just functional, but
                transformative. We believe that great software should be intuitive, scalable, and built to last.
              </Text>
              <Text size="4" className="text-muted-foreground leading-relaxed">
                Every project we undertake is an opportunity to push the boundaries of what's possible, delivering
            ...
            <Box>
              ...
              <Text size="4" className="text-muted-foreground leading-relaxed mb-6">
                We combine technical expertise with strategic thinking to deliver solutions that align with your
                business goals. Our agile methodology ensures rapid iteration and continuous improvement.
              </Text>
        ...
        <Container size="4">
          ...
          <Grid columns={{ initial: "1", md: "3" }} gap="8" className="max-w-6xl mx-auto">
            <Card className="p-8 text-center">
              <Box className="w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <Card className="p-8 text-center">
              ...
              <Text className="text-muted-foreground leading-relaxed">
                We work as an extension of your team, fostering open communication and shared ownership of project
                success.
              </Text>
            </Card>
            ...
            <Card className="p-8 text-center">
              ...
              <Text className="text-muted-foreground leading-relaxed">
                We embrace new technologies and methodologies, constantly evolving to deliver cutting-edge solutions.
              </Text>
            </Card>
          </Grid>
        </Container>
      ...
      <Section className="py-20">
        <Container size="4">
          <Grid columns={{ initial: "2", md: "4" }} gap="8" className="max-w-4xl mx-auto text-center">
            <Box>
      ...
      <Section className="py-20 bg-muted">
        <Container size="4">
          <Flex direction="column" align="center" className="text-center mb-16">
            ...
            <Text size="5" className="text-muted-foreground max-w-2xl">
              We're more than just developers – we're your strategic technology partners
            </Text>
          </Flex>
          ...
          <Grid columns={{ initial: "1", md: "2" }} gap="8" className="max-w-4xl mx-auto">
            <Card className="p-6">
              ...
              <Text className="text-muted-foreground leading-relaxed">
                With over 100 successful projects across various industries, we have the experience and expertise to
            ...
            <Card className="p-6">
              ...
              <Text className="text-muted-foreground leading-relaxed">
                From initial concept to deployment and maintenance, we provide comprehensive services that cover every
            ...
            <Card className="p-6">
              ...
              <Text className="text-muted-foreground leading-relaxed">
                Our agile development process ensures rapid delivery while maintaining flexibility to adapt to changing
                requirements.
              </Text>
            </Card>
            ...
            <Card className="p-6">
              ...
              <Text className="text-muted-foreground leading-relaxed">
                We build lasting relationships with our clients, providing ongoing support and evolution of your
                software solutions.
              </Text>
            </Card>
          </Grid>
